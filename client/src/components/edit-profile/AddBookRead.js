...
import { addBookRead } from "../../actions/profileActions";
var querystring = require("querystring");

class AddBookRead extends Component {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
  ...
  onAddBookClick(index) {
    ...
    this.props.addBookRead(bookData);
  }
  onSubmit(e) {
    e.preventDefault();
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <p className="lead text-center">Add a book that you have read</p>
